...
export const AppContextProvider = (props) => {
  ...
  const fetchUserEnrolledCourses = async () => {
    try {
      ...
      if (data.success) {
        setEnrolledCourses(data.enrolledCourses.reverse()) //reverse the courses we will get new courses at the top.
      }
      else {
        toast.error(data.message)
      }
  ...
  const contextValue = {
    ...
    fetchUserData,backendUrl,userData,setUserData,getToken , fetchAllCourses
