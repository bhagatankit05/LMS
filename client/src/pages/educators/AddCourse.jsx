            ...
            <div key={chapterIndex} className='bg-white border rounded-lg mb-4'>
              ...
              {!chapter.collapsed && (
                <div className='p-4'>
                  ...
                  <div className='inline-flex bg-gray-100 p-2 rounded cursor-pointer mt-2' onClick={() => handleLecture('add', chapter.chapterId)}>+ Add Lectures</div>
                </div>
              )}

            </div>
          ))}
          <div className='flex justify-center items-center bg-orange-400 p-2 rounded-lg cursor-pointer' onClick={() => handleChapter('add')}>+ Add Chapter</div>

          {showPopop && (
            <div className='fixed inset-0 flex items-center justify-center backdrop-blur-md backdrop-brightness-75 z-50'>
              <div className='bg-white/80 backdrop-blur-lg text-gray-700 p-4 rounded relative w-full max-w-80 shadow-xl'>
